        ...
        for( var i=0; i<link.visuals.length; i++ ) {
            ...
            if (visual && visual.geometry) {
                ...
                if (visual.geometry.type === ROSLIB.URDF_MESH) {
                    ...
                    if(visual.geometry.dimension.x == 0)
                        visual.geometry.dimension.x = 0.00001;
                    if(visual.geometry.dimension.y == 0)
                        visual.geometry.dimension.y = 0.00001;
                    if(visual.geometry.dimension.z == 0)
                        visual.geometry.dimension.z = 0.00001;
